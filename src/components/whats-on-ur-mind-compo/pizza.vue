    ...
    async loadRestaurants() {
      try {
        const req = await fetch(
          "https://www.swiggy.com/dapi/restaurants/list/v5?lat=10.51600&lng=76.21570&collection=83631&tags=layout_CCS_Pizza&sortBy=&filters=&type=rcv2&offset=0&page_type=null" );
