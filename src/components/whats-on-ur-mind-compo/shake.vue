    ...
    async loadRestaurants() {
      try {
        const req = await fetch(
          "https://www.swiggy.com/dapi/restaurants/list/v5?lat=10.51600&lng=76.21570&collection=83673&tags=layout_CCS_Shakes&sortBy=&filters=&type=rcv2&offset=0&page_type=null" );
